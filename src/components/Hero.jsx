    ...
    return (
        <div className='w-full h-[500px] lg:h-[750px]'>
            <div className='w-full h-full'>
                <div className='absolute w-full h-[500px] lg:h-[750px] bg-gradient-to-r from-black' />
                ...
                <div className='absolute w-full top-[15%] lg:top-[25%] p-4 md:p-8'>
                    ...
                    <div className='mt-8 mb-4'>
                        ...
                        <button className='capitalize border border-gray-300 py-2 px-5 ml-4 hover:text-black hover:bg-gray-300'>
                            watch later
                        </button>
                    </div>
